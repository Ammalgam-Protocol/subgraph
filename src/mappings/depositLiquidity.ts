...
import { Mint as DepositEvent } from '../types/templates/ERC20DepositLiquidity/ERC20DepositLiquidity'
...
export function handleDepositLiquidity(event: DepositEvent): void {
